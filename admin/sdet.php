...
<body>
    ...
    <div class="container">
        ...
        <div class="buttons">
            ...
            <div style="margin-left: 200px;"> <a href="services.php" class="btn btn-warning">Add New</a>
            ...
            include "config.php";
            $qry=mysqli_query($con,"SELECT * FROM service,provider WHERE service.pid=provider.pid");
