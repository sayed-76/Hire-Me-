...
<body>
  <div class="container">
    <h2 style="text-align:center;font-size:50px;">Customer Sign In</h2><br>
    ...
    <form action="" method="POST">
      ...
      <a href="creg.html">New you can Rgister</a>
    ...
    if(isset($_POST['login']))
    {
        ...
        $qry=mysqli_query($con,"select * from cust where name='$name' and password='$pass'");
