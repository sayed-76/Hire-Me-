...
<body>
    ...
    <div class="container">
        ...
        <div class="buttons">
            ...
            <a href="creg.html"  style="text-align:center;margin:50px;font-size:50px;" class="btn btn-primary">Customer</a>
            <a href="preg.html"  style="text-align:center;margin:50px;font-size:50px;" class="btn btn-primary">Provider</a>
        </div>
        </div>
    </div>
